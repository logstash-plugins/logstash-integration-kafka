...
* `uniform_sticky` switches to a new partition after every batch.size bytes are produced, ensuring uniform distribution across partitions. This is the default strategy of Kafka client.
