## 12.2.0
  - Added `commit_after_pq_fsync` option to the input: commit Kafka offsets only after the Logstash persistent queue has fsynced the polled batch to disk [#PR](https://github.com/logstash-plugins/logstash-integration-kafka/pull/PR)
