...
require_jar('io.confluent', 'kafka-avro-serializer', '6.2.15')
require_jar('io.confluent', 'kafka-schema-serializer', '6.2.15')
require_jar('io.confluent', 'common-config', '6.2.15')
require_jar('org.apache.avro', 'avro', '1.11.4')
require_jar('io.confluent', 'kafka-schema-registry-client', '6.2.15')
require_jar('org.apache.kafka', 'kafka_2.12', '2.8.1')
require_jar('io.confluent', 'common-utils', '6.2.15')
